...
dbLoadRecords("iocSoft.db", "IOC=PLC:PLC_CRIX_VAC")
dbLoadRecords("save_restoreStatus.db", "P=PLC:PLC_CRIX_VAC:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:PLC_CRIX_VAC")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:PLC_CRIX_VAC")
...
save_restoreSet_status_prefix( "PLC:PLC_CRIX_VAC:" )
